...
window._s3Lang['FIND_LOST_IMAGE'] = "Найти потерянные изображения ";
window._s3Lang['FIND_LOST_IMAGE_WARNING'] = "Предупреждение:<ul> <li>Потерянные изображения будут восстановлены.</li> <li>Если на сайте имеются иллюстрации, которые не открываются (или отдают 404 ошибку) - ошибки будут исправлены, иллюстрации начнут отображаться корректно</li></ul>";
...
window._s3Lang['NABOKA_NEW_TEST'] = "Заказ номер: {$order.number}";
window._s3Lang['PAYMENT_SYSTEMS_SHOP2_PANEL'] = "Платежные<br/>системы";
window._s3Lang['BUY_ONE_CLICK_SHOP2_PANEL'] = "Купить<br/>в один клик";
window._s3Lang['SHOP2_PRODUCTS2_VARIANTS'] = "Вариантов товаров";
window._s3Lang['POCHTAFORM_ECOM_MARKETPLACE'] = "ЕКОМ Маркетплейс";
